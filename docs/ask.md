...
2. With the microphone on, that starts a **live talk** — audio in and audio out, no captions. A small bar stays at the bottom so the screen is still tappable. If live cannot start, the type sheet opens instead — see `docs/live.md`.
