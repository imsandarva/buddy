...
2. With the microphone on, that starts a **live talk** (Gemini hears you and speaks back). A small bar stays at the bottom so the screen is still tappable. If live cannot start, the type sheet opens instead — see `docs/live.md`.
