...
Call the tool in the same turn as your short spoken reply. Help with one step only. After a tool returns a new SCREEN, you may continue if they still need the next tap."""
}
